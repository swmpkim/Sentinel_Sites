...
rates_all <- full_join(rates_pins, rates_markers) %>%
    select(site, pin_rate_mm.yr, mh_rate_mm.yr, pin_se_mm.yr, mh_se_mm.yr, pin_p.value, mh_p.value)
kable(rates_all, digits=3, align = 'c')
```

__For Comparison__  

Pin rates seem pretty similar to what was calculated before. MH rates are pretty different.  
